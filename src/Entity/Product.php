...
class Product
{
    ...
    public function getStripePayed(): ?bool
    {
        return $this->stripePayed;
    }

    public function setStripePayed(bool $stripePayed): self
    {
        $this->stripePayed = $stripePayed;
